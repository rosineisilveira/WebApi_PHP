...
$routes->add('/contact/insertContactAction','Contact::insertContactAction');
...
$routes->get('/admin/getClientsJs','Admin\Client::getClientsJs');

$routes->add('/admin/listContatos','Admin\Contact::listContacts');
